...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText project_tag_et;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        project_tag_et = findViewById(R.id.activity_main_project_tag_et);
        ...
        gotoSDK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                project_tag = project_tag_et.getText().toString();
                ...
                intent.putExtra(ARG_KEY_PROJECT_TAG, project_tag);
